...
clang -DPLATFORM_PC -Wall -dynamiclib -o libapp.so $AP/app.c $AP/platform_pc.c $AP/../can/canvar_defs.c $AP/canvar.c $AP/warn.c $AP/drive.c $AP/version.c $AP/modes.c
