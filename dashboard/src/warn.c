...
#define BLINK_OIL_PRESSURE (0)
    {SCR_BYTE_ADDR(0, 0, 8), SCR_BYTE_ADDR_AT_TEXT(0, 4, 5),
        PIC_ID_OIL_PRESSURE, 7*6+1},
#define BLINK_OIL_TEMP (1)
    {SCR_BYTE_ADDR(0, 0, 24), SCR_BYTE_ADDR_AT_TEXT(0, 13, 5),
        PIC_ID_OIL_TEMP, 4*6},
#define BLINK_WATER_TEMP (2)
    {SCR_BYTE_ADDR(0, 4, 8), SCR_BYTE_ADDR_AT_TEXT(0, 6, 6),
        PIC_ID_WATER_TEMP, 4*6+1},
#define BLINK_BLOCK_TEMP (3)
    {SCR_BYTE_ADDR(0, 4, 24), SCR_BYTE_ADDR_AT_TEXT(0, 13, 6),
        PIC_ID_BLOCK_TEMP, 4*6+1},
#define BLINK_FUEL_PRESSURE (4)
    {SCR_BYTE_ADDR(0, 8, 8), SCR_BYTE_ADDR_AT_TEXT(0, 4, 7),
        PIC_ID_FUEL_PRESSURE, 7*6+1},
#define BLINK_FUEL_TEMP (5)
    {SCR_BYTE_ADDR(0, 8, 24), SCR_BYTE_ADDR_AT_TEXT(0, 13, 7),
        PIC_ID_FUEL_TEMP, 4*6+1},
#define BLINK_BATTERY (6)
    {SCR_BYTE_ADDR(0, 12, 8), SCR_BYTE_ADDR_AT_TEXT(0, 35, 7),
        PIC_ID_BATTERY, 5*6},
#define BLINK_OIL_TEMP_LOW (7)
    {SCR_BYTE_ADDR(0, 12, 24), SCR_BYTE_ADDR_AT_TEXT(0, 13, 5),
