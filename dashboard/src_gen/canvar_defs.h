...
#define CV_ID_B_AUTOSHIFTEN_EMS (0)
#define cv_B_autoshiften_ems (canvar_states[0])
#define CV_ID_APS (1)
#define cv_aps (canvar_states[1])
#define CV_ID_B_LAUNCH (2)
#define cv_B_launch (canvar_states[2])
#define CV_ID_WB_VERSION_COMMIT (3)
#define cv_wb_version_commit (canvar_states[3])
#define CV_ID_WB_VERSION_BUILD (4)
#define cv_wb_version_build (canvar_states[4])
#define CV_ID_WB_UPSHIFT (5)
#define cv_wb_upshift (canvar_states[5])
#define CV_ID_WB_DOWNSHIFT (6)
#define cv_wb_downshift (canvar_states[6])
#define CV_ID_WB_DASH_MODE (7)
#define cv_wb_dash_mode (canvar_states[7])
#define CV_ID_WB_RADIO (8)
#define cv_wb_radio (canvar_states[8])
#define CV_ID_WB_TRACTION_KNOB (9)
#define cv_wb_traction_knob (canvar_states[9])
#define CV_ID_PCLUTCH (10)
#define cv_pclutch (canvar_states[10])
...
#define CANVAR_ID_MAP_COUNT (20)
extern const uint8_t canvar_id_map[20];
