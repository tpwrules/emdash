...
#define cv_tmot (canvar_states[5])
#define cv_tmot2 (canvar_states[6])
#define cv_toil (canvar_states[7])

extern volatile canvar_state_t canvar_states[8];
extern const canvar_def_t canvar_defs[8];

#define CANVAR_NUM_VARS (8)
